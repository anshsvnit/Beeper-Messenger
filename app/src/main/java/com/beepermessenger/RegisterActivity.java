...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void parsingUserResponse(String response) {
        ...
        try {
            ...
            new ImageLoader(RegisterActivity.this).DisplayImage(objectProfile.optString("profileImage"), R.drawable.ic_launcher, ivProfile);
        } catch (Exception e) {
    ...
    private void isEdit() {
        if (SPUser.getLong(RegisterActivity.this, SPUser.USER_ID) != 0) {
            ...
            params.put("user_id", SPUser.getLong(RegisterActivity.this, SPUser.USER_ID) + "");
            new CustomHttpClient(RegisterActivity.this).executeHttpPost(CommonUtilities.USER_INFO, params, progress, new CustomHttpClient.OnSuccess() {
                @Override
    ...
    private void displayMessage(Profile profile) {
        ...
        String android_id = Settings.Secure.getString(RegisterActivity.this.getContentResolver(),
        ...
        new CustomHttpClient(RegisterActivity.this).executeHttpPost(CommonUtilities.LOGIN_URL, params, progress, new CustomHttpClient.OnSuccess() {
            @Override
            public void onSucess(String result) {
    ...
    private void parsingResponse(String response) {
        ...
        try {
            ...
            if (status.equals("true")) {
                ...
                SPUser.setLong(RegisterActivity.this, SPUser.USER_ID, objectProfile.optLong("user_id"));
                SPUser.setString(RegisterActivity.this, SPUser.EMAIL, objectProfile.optString("email"));
                SPUser.setString(RegisterActivity.this, SPUser.PASSWORD, objectProfile.optString("password"));
                SPUser.setString(RegisterActivity.this, SPUser.NAME, objectProfile.optString("name"));
                SPUser.setString(RegisterActivity.this, SPUser.ABOUT, objectProfile.optString("about"));
                SPUser.setString(RegisterActivity.this, SPUser.PHONE, objectProfile.optString("phone"));
                SPUser.setString(RegisterActivity.this, SPUser.GENDER, objectProfile.optString("gender"));
                SPUser.setString(RegisterActivity.this, SPUser.D_O_B, objectProfile.optString("dob"));
                SPUser.setString(RegisterActivity.this, SPUser.COUNTRY, objectProfile.optString("country"));
                SPUser.setString(RegisterActivity.this, SPUser.STATE, objectProfile.optString("state"));
                SPUser.setString(RegisterActivity.this, SPUser.PROFILE_IMAGE, objectProfile.optString("profileImage"));

                Log.e("inside register", "" + objectProfile.length());
                Intent i = new Intent(RegisterActivity.this, BaseActivity.class);
                startActivity(i);
                finish();
            } else {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.tv_register_gender:
                    spinnerDialog = new Dialog(RegisterActivity.this);
                    ...
                    gender.add("Male");
                    gender.add("Female");
                    spinnerListview.setAdapter(new ArrayAdapter<String>(RegisterActivity.this,
                ...
                case R.id.tv_register_dob:
                    new DatePickerDialog(RegisterActivity.this, fromPickerListener, year,
                            month, day).show();
                    break;
                ...
                case R.id.btn_register_next:
                    if (checkValidation()) {
                        if (NetworkConnection.getInstance(RegisterActivity.this).isOnline(RegisterActivity.this)) {
                            new RegisterTask().execute();
                        } else {
                            Toast.makeText(RegisterActivity.this, "Please Provide Internet.", Toast.LENGTH_LONG).show();
                        }
    ...
    private boolean checkValidation() {
       ...
       /* if (tvRegisterDOB.getText().toString().equals("")) {
        ...
        if (selectedImagePath == null && SPUser.getLong(RegisterActivity.this, SPUser.USER_ID) == 0) {
            Toast.makeText(RegisterActivity.this, "Please Upload Picture", Toast.LENGTH_LONG).show();
            isValidated = false;
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RequestCodes.CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(RegisterActivity.this, "Sorry! Failed to capture image",
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                if (SPUser.getLong(RegisterActivity.this, SPUser.USER_ID) == 0) {
                    ...
                    u.addField("id", SPUser.getLong(RegisterActivity.this, SPUser.USER_ID) + "");
                }
            ...
            try {
                ...
                if (reply == null) {
                    ...
                    if (jsonObject.optBoolean("status")) {
                        ...
                        long tmp = SPUser.getLong(RegisterActivity.this, SPUser.USER_ID);
