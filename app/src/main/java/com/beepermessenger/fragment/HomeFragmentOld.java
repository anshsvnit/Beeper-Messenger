 ...
 * Use the {@link HomeFragmentOld#newInstance} factory method to
...
public class HomeFragmentOld extends Fragment {
     ...
     * @return A new instance of fragment HomeFragmentOld.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*if (shouldCreateChild) {
            ...
            fragmentTransactionHome.add(R.id.myfragment, listFragment);
            //fragmentTransactionHome.addToBackStack(null);
            fragmentTransactionHome.commit();
        }
      */
        lvFriend = (ListView) v.findViewById(R.id.lv_friend);
